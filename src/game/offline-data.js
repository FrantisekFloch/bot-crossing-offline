...
export const OFFLINE_THREADS = [
  ...
  // ---- FILLER BOTS (static idle — no badge, just fill out the colony) ------
  // Purely there to make the screen feel full. All idle: no attention needed.
  bot({
    id: 'kiro:acm-offset',
    harness: 'kiro',
    harnessName: 'Kiro',
    title: 'ACM offset analysis — service-center rollup',
    projectLabel: 'ACM · offsets',
    preview: 'Offset-by-service-center summary exported to Excel.',
    folder: 'ACM',
    model: 'auto',
    lastActivityAt: now - 11 * HOUR,
    sizeBytes: 132_000,
  }),
  bot({
    id: 'claude-code:company-demos',
    harness: 'claude-code',
    harnessName: 'Claude Code',
    title: 'Company demo sites — shared styles pass',
    projectLabel: 'Demos · styles',
    preview: 'Unified the card grid across the five demo sites.',
    folder: 'Company_Product',
    model: 'claude-sonnet',
    lastActivityAt: now - 14 * HOUR,
    sizeBytes: 205_000,
  }),
  bot({
    id: 'codex:sql-optimizer',
    harness: 'codex',
    harnessName: 'Codex',
    title: 'SQL optimizer — query plan hints',
    projectLabel: 'SQL · optimizer',
    preview: 'Drafted index suggestions for the aging queries.',
    folder: 'SQL_Optimizer',
    model: 'gpt-5',
    effort: 'medium',
    lastActivityAt: now - 16 * HOUR,
    sizeBytes: 61_000,
  }),
  bot({
    id: 'cursor:month-end-docs',
    harness: 'cursor',
    harnessName: 'Cursor',
    title: 'Month-end documents — template scaffold',
    projectLabel: 'Month-end · docs',
    preview: 'Set up the reporting template placeholders.',
    folder: 'Month_End_Documents',
    lastActivityAt: now - 20 * HOUR,
    sizeBytes: 38_000,
  }),
  bot({
    id: 'kiro:adjustment-recon',
    harness: 'kiro',
    harnessName: 'Kiro',
    title: 'Adjustment reconciliation — dashboard build',
    projectLabel: 'Adj recon · dash',
    preview: 'Portfolio reconciliation dashboard generated.',
    folder: 'Adjstment_Reconciliation',
    model: 'auto',
    lastActivityAt: now - 26 * HOUR,
    sizeBytes: 178_000,
  }),
  bot({
    id: 'claude-code:3f-bot',
    harness: 'claude-code',
    harnessName: 'Claude Code',
    title: '3F Bot — chat widget polish',
    projectLabel: '3F Bot · widget',
    preview: 'Tidied the web chat styles and config.',
    folder: '3F_Bot',
    model: 'claude-sonnet',
    lastActivityAt: now - 32 * HOUR,
    sizeBytes: 72_000,
  }),
  bot({
    id: 'codex:yearly-review',
    harness: 'codex',
    harnessName: 'Codex',
    title: '2026 yearly review — metrics draft',
    projectLabel: 'Review · metrics',
    preview: 'Compiled the year-over-year figures.',
    folder: '2026_Review',
    model: 'gpt-5',
    effort: 'low',
    lastActivityAt: now - 40 * HOUR,
    sizeBytes: 55_000,
  }),
]
