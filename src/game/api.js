...
import { offlineThreadsResponse } from './offline-data.js'
...
// OFFLINE BUILD: the colony is populated from a fixed, fabricated set of threads instead of
// scanning the local machine. See src/game/offline-data.js. This keeps every downstream
// behaviour (badges, zones, layout) identical while requiring no /api/threads backend.
export const fetchThreads = async () => offlineThreadsResponse()
